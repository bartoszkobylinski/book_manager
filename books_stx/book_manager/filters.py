...
class BookFilter(django_filters.FilterSet):
    ...
    publish_year__gt = django_filters.NumberFilter(
        field_name="publish_year", lookup_expr="gt"
    )
    publish_year__lt = django_filters.NumberFilter(
        field_name="publish_year", lookup_expr="lt"
    )
