...
class TestGoogleAPIParser(TestCase):
    ...
    def test_string_method_for_google_parser(self):
        self.assertEqual(
            self.google_parser.__str__(),
            f"Google API parser for website: {GOOGLE_API_KEY}",
        )
